        ...
        <div class="row">
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <div class="d-flex flex-row bd-highlight mb-3">
                    ...
                    <div class="p-1 bd-highlight mt-2"><a href="{{ route('withdrawal-request.index')}}" class="text-decoration-none text-dark"><h6 class="mt-1">Withdraw History</h5></a></div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-3">
                                                <select class="form-control" name="status" id="subscriber-status-filter">
                                                    ...
                                                    <option value="0"
                                                        @if (app('request')->input('status') == '0') selected @endif>Rejected</option>
                                                    <option value="1"
                                                        @if (app('request')->input('status') == '1') selected @endif>Success</option>
                                                    <option value="2"
                                                        @if (app('request')->input('status') == '2' || app('request')->input('status') == '') selected @endif>Pending</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-12 col-md-3 vertical-center d-flex"
                                                ...
                                                <a class="btn btn-warning btn-sm btn-xs-block d-inline"
                                                    href="{{ route('withdrawal-request.index') }}"
                    ...
                    @include('backend.superadmin.withdraw.table', $withdraws)
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="refuseModalLabel">Refuse Reason</h5>
...
@section('script')
    ...
    <script type="text/javascript">
        function changeStatus(id, type, reason) {
            var url = "{{ route('withdrawal.change-status') }}";
