...
@if (\Request::route()->getName() == "poll.create")
<button type="submit" class="btn btn-primary mr-2">Save</button>
<a class="btn btn-light" href="{{route('poll.index', [request()->route('pollID')])}}">Cancel</a>
@else
@php $id= App\Helpers\CustomHelper::getEncrypted($mainpoll['id']); @endphp
<button type="submit" class="btn btn-primary mr-2">Update</button>
<a class="btn btn-light" href="{{route('poll.index', [$id])}}">Cancel</a>
@endif
